/*****************************************************************//**
 * \file   main.cpp
 * \brief  This is the main file for the SOP problem.
 * 
 * \author Qiuchen Qian
 * \date   October 2023
 *********************************************************************/
...
void initialize(const string config_fpath, const bool print_config)
{
	...
	DataIO::load_sop_data(data_fdir, data_fname, all_circs);
	// Initialize SZS
...
{
	// string config_fname = "general.sop.json";
	// data_fname = "bubbles1";
	...
	DataIO::write_sop_sol(data_fdir, data_fname, end_time, ".acs", 
